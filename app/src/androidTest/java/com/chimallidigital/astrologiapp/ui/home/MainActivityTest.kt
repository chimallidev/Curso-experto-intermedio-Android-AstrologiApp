package com.chimallidigital.astrologiapp.ui.home
...
import com.chimallidigital.astrologiapp.ui.detalles.DetallesHoroscopoActivity
...
class MainActivityTest {
    ...
    fun when_horoscopo_is_selected_then_open_detail(){
        ...
        intended(hasComponent(DetallesHoroscopoActivity::class.java.name))
    }
}